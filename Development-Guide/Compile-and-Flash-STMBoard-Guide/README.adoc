...
=======
This should download the necessary tools needed (gcc4mbed, STlink, and CubeMX2Makefile)
>>>>>>> c6bcc45e6d5e365c56b88dfae0bbe5e61fd5383b
...
For example, use `unzip file.zip -d Destination_folder`.
...
=======
. Create the makefile using  `/usr/local/bin/CubeMX2Makefile /path/to/project/folder`.
>>>>>>> c6bcc45e6d5e365c56b88dfae0bbe5e61fd5383b
...
To flash the board use `/usr/local/bin/st-flash write /path/to/project/build/<project>.bin 0x8000000`.
